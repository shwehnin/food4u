...
class SubCategoryItemScreen extends StatefulWidget {
  const SubCategoryItemScreen({Key? key}) : super(key: key);
...
class _SubCategoryItemScreenState extends State<SubCategoryItemScreen> {
  ...
  void didChangeDependencies() {
    ...
    if (settings.arguments != null) {
      ...
      setState(() {
        _token = data[0].toString();
        _keyword = data[1].toString();
        _title = data[2].toString();
        _onBackPressed = data[3].toString();
        _category = data[4].toString();
        _subCategory = data[5].toString();
      });
      _initializedBloc();
    }
