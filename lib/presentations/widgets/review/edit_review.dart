...
class _EditReviewScreenState extends State<EditReviewScreen> {
  ...
  void initState() {
    ...
    msgController.text = widget.message;
    rating = widget.ratingVale;
  }
